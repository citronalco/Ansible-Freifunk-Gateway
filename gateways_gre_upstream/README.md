...
```
`name` ist ein frei wählbarer Name für den Tunnel (Achtung: Keine Bindestriche verwenden!), aus dem die Bezeichnung für die virtuelle Netzwerkschnittstelle des Tunnels gebildet wird: Tunnel "dus" liegt auf Interface "tun-ffrl-dus", "fra" auf "tun-ffrl-fra".
